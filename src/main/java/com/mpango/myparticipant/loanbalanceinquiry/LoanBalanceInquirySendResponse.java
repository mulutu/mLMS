...
public class LoanBalanceInquirySendResponse implements AbortParticipant {

    static Logger logger = Logger.getLogger(LoanBalanceInquirySendResponse.class);
    ...
    private void sendResponse(long id, Context ctx) {
        ...
        try {
            ...
            if (source != null && source.isConnected() && msg != null) {
                ...
                BigDecimal loanBalance = (BigDecimal) ctx.get(Constant.LOAN_BALANCE);
                String loanDueDate = (String) ctx.get(Constant.LOAN_DUE_DATE);
                ...
                if (rc == null || "00".equals(rc)) {
                    ...
                    msgResponse.set(7, loanDueDate.substring(0, 10));
                    ...
                    msgResponse.set(44, loanBalance.toPlainString());

                    SMSMessage = "Dear customer, your loan (" + loanRefNumber + ") balance is " + loanBalance.toPlainString() + " due on " + loanDueDate.substring(0, 10);
            ...
            java.util.logging.Logger.getLogger(LoanBalanceInquirySendResponse.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
